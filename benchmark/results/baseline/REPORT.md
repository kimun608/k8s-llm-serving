...
| 2 | 100.0% | 0.119 | 7.64 | 15.63 / 22.32 | 3.66 / 11.93 | 163.86 / 319.15 | 0 | 13.4% | 5.99 | 6.05GiB |
...
Peak Pod memory는 최대 `6.05GiB`였고 OOM kill은 `0`회였다. 따라서 높은 latency의 원인은 Pod OOM/restart가 아니라 고정 CPU capacity, KV 포화, scheduler queue로 해석할 수 있다.

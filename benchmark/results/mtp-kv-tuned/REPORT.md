...
이 문서는 해당 설정의 원시 요청과 1초 metric 시계열에서 자동 생성한 사실표다. baseline과의 before/after 및 개선·악화 원인은 [`reports/results/04_OPTIMIZATION_FINAL_ANALYSIS.md`](../../../reports/results/04_OPTIMIZATION_FINAL_ANALYSIS.md)에서 교차 분석한다.

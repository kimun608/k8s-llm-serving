...
| 5 | 100.0% | 0.172 | 11.01 | 22.85 / 52.59 | 13.61 / 28.69 | 128.94 / 424.69 | 0 | 32.8% | 6.66 | 5.92GiB |
...
이 문서는 해당 설정의 원시 요청과 1초 metric 시계열에서 자동 생성한 사실표다. baseline과의 before/after 및 개선·악화 원인은 [`reports/05_BASELINE_CPU8_ANALYSIS.md`](../../../reports/05_BASELINE_CPU8_ANALYSIS.md)에서 교차 분석한다.
